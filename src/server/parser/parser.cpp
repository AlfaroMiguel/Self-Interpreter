...
#line 115 "parser.cpp" /* yacc.c:355  */
...
{
       0,    38,    38,    40,    44,    51,    54,    58,    62,    69,
      73,    81,    85,    88,    95,    98,   105,   108,   115,   120,
     124,   128,   132,   138,   143,   148,   150,   155,   159,   162,
     169,   174
};
#endif
...
static const char *const yytname[] =
{
  ...
  "EQUALS", "PRINT", "LPAREN", "RPAREN", "SEMICOLON", "EQUALSMUTAL", "SET",
  "BAR", "ADD", "RM", "CREATEOBJECTINIT", "CREATEOBJECTEND", "ARGS",
  "WORD", "COMMENT", "VARIABLE", "SELF", "NUMBER", "$accept", "parse",
  "lines", "line", "argument", "atom_expression", "expression", "inner1",
  "inner2", YY_NULLPTR
};
#endif
...
{
      63,    -8,     9,     9,    27,    -8,    79,    -8,    15,     8,
      -8,    -8,     7,    33,    -8,    -8,     1,    73,    -8,     5,
      39,    12,    22,    63,    -8,     9,     9,    63,    63,    44,
      -8,    -8,     9,     9,     9,     9,    -8,    -8,    -8,     9,
      28,    51,     3,    85,    54,    55,    -8,    33,    33,    -8,
      -8,    94,    56,    -8,    -8,    -8,    -8,    -8,    59,    -8,
      -8
};
...
{
       0,    15,     0,     0,     0,    22,    29,    30,     0,     0,
       4,    12,    14,    25,    28,    29,     0,     0,     7,    22,
       0,     0,     0,     0,    18,     0,     0,     0,     0,     0,
       1,     3,     0,     0,     0,     0,     5,    31,     6,     0,
       0,     0,     0,     0,     0,     0,    13,    23,    24,    26,
      27,     0,     0,    10,    19,    20,     8,     9,     0,    21,
      11
};
...
{
      16,    17,    31,    20,    32,    33,    32,    33,    -2,     1,
      32,    33,    36,    31,    54,    30,     2,     3,     3,   -17,
      44,    45,    41,    42,    43,     4,    39,     5,     1,    40,
       6,    15,     7,     7,    31,     2,     3,    51,    34,    35,
       1,   -16,    47,    48,     4,    18,    19,     2,     3,     6,
      52,     7,     1,    49,    50,    46,     4,    38,     5,     2,
       3,     6,    53,     7,     1,    56,    57,    59,     4,    60,
       5,     2,     3,     6,     0,     7,    32,    33,     0,     0,
       4,     0,     5,    37,    22,     6,    23,     7,    32,    33,
      24,    25,    26,     0,    27,    28,    55,    32,    33,     0,
       0,    29,     0,     0,     0,    58
};
...
{
       2,     3,     9,     4,     3,     4,     3,     4,     0,     1,
       3,     4,    11,    20,    11,     0,     8,     9,     9,    14,
      27,    28,    23,    25,    26,    17,    14,    19,     1,     7,
      22,    22,    24,    24,    41,     8,     9,    39,     5,     6,
       1,    14,    32,    33,    17,    18,    19,     8,     9,    22,
      22,    24,     1,    34,    35,    11,    17,    18,    19,     8,
       9,    22,    11,    24,     1,    11,    11,    11,    17,    10,
      19,     8,     9,    22,    -1,    24,     3,     4,    -1,    -1,
      17,    -1,    19,    10,     5,    22,     7,    24,     3,     4,
      11,    12,    13,    -1,    15,    16,    11,     3,     4,    -1,
      -1,    22,    -1,    -1,    -1,    11
};
...
{
       0,     1,     8,     9,    17,    19,    22,    24,    26,    27,
      28,    30,    31,    32,    33,    22,    31,    31,    18,    19,
      27,    29,     5,     7,    11,    12,    13,    15,    16,    22,
       0,    28,     3,     4,     5,     6,    11,    10,    18,    14,
       7,    27,    31,    31,    28,    28,    11,    32,    32,    33,
      33,    31,    22,    11,    11,    11,    11,    11,    11,    11,
      10
};
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, Interpreter * interpreter)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (interpreter);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, Interpreter * interpreter)
{
  YYFPRINTF (yyoutput, "%s %s (",
             yytype < YYNTOKENS ? "token" : "nterm", yytname[yytype]);

  yy_symbol_value_print (yyoutput, yytype, yyvaluep, interpreter);
  YYFPRINTF (yyoutput, ")");
}
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, int yyrule, Interpreter * interpreter)
{
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, Rule, interpreter); \
} while (0)
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, Interpreter * interpreter)
{
  YYUSE (yyvaluep);
  YYUSE (interpreter);
  if (!yymsg)
...
int
yyparse (Interpreter * interpreter)
{
    int yystate;
...
#line 63 "parser.y" /* yacc.c:1646  */
    {
		interpreter->pushToken(*(yyvsp[-3].str_val),"add","");
		std::cout << "Liberando:" <<(yyvsp[-3].str_val)<<std::endl;
		std::cout << "Tiene:" <<*(yyvsp[-3].str_val)<<std::endl;
...
#line 120 "parser.y" /* yacc.c:1646  */
    {
							interpreter->pushToken(*(yyvsp[-3].str_val),"assignation_mutable","");
							interpreter->pushToken(*(yyvsp[-3].str_val),"assignation","");
							}
...
#line 128 "parser.y" /* yacc.c:1646  */
    {
							...
							interpreter->pushToken(*(yyvsp[-1].str_val),"clone","");
							}
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  yystos[yystate], yyvsp, interpreter);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  yystos[*yyssp], yyvsp, interpreter);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
